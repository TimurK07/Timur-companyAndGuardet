              ...
              <div className="main_student_subtitle">
                <div className="rows">
                  <div className="row row__speciality ">
                    ...
                    <p className='row__speciality-subtitle'>1305000 Программное обеспечение</p>
                  </div>
                  <div className="row row__qualification">
                    <span className="no-select">Квалификация</span>
                    <p className='row__qualification-subtitle'>130502 3 “Техник-программист”</p>
                  </div>
                  <div className="row row__phone">
                    <span className="no-select">Номер телефона </span>
                    <p className='row__phone-subtitle'>+7 (707) 777 77 77</p>
                  </div>
                  <div className="row row__mail">
                    <span className="no-select">Почта </span>
                    <p className='row__mail-subtitle'>ivanivanov@mail.ru</p>
                  </div>
                  <div className="row row__dateofbirth">
                    <span className="no-select">Дата рождения </span>
                    <p className='row__dateofbirth-subtitle'>1 сентября 2000 г.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="characteristic__section">
        <div className="characteristic__section__container _container">
          ...
          <div className="characteristic">
            <p className="characteristic__subtitle no-select">
              Студент-практикант Ф.И.О. в период с 29.06.2015 г. по 12.07.2015
              г. проходил учебно-ознакомительную практику в магазине ООО
              «Центральное», расположенном по адресу: г. Южно-Сахалинск, ул.
              Ленина 218 в качестве помощника руководителя. В течение всего
              периода практики, Ф.И.О. внимательно и ответственно относился к
              выполняемой работе. Изучал методы управления и основные методы
              мотивации персонала, должностные обязанности персонала, пробовал
              проводить анализ хозяйственной деятельности организации за
              последние три года, ознакомился с порядком ведения различных
              распорядительных документов, учетной документации, изучал
              организационную структуру предприятия, участвовал в различной
              повседневной работе. Всю порученную работу выполнял добросовестно
              и в срок. Стремился приобретать новые знания, чтобы быть ещё более
              полезным на месте практики. Неоднократно оказывал помощь
              сотрудникам организации. Руководство организации оценивают работу
              Ф.И.О. на «отлично».
            </p>
          </div>
        </div>
